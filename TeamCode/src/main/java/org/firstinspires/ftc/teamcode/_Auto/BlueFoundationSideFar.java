...
@Autonomous(name="BLUE Foundation Park Bridge")
public class BlueFoundationSideFar extends OpMode {
    ...
    public int travDist(float in){
        double c = 560/(4*(Math.PI)); //TODO: See if this needs to get changed to 450/4pi (?)
